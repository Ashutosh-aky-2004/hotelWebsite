...
<div class="container avability-form">
  <div class="row">
    ...
    <div class="col-lg-12 bg-white shadow p-4 rounded">
      <h5>Check Booking Avaiability</h5>
      <form>
        <div class="row">
...
<h2 class="mt-5 pt-4 mb-5 text-center h-font">Testimonials</h2>
<div class="container">
  <div class="swiper swiper-testimonials">
    <div class="swiper-wrapper mb-5">
      <div class="swiper-slide bg-white p-4">
        <div class="profile d-flex align-items-center mb-3">
          <img src="images/facilities/fire.svg" width="30px">
          <h6 class="m-0 ms-2">Random User1</h6>
        </div>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
          Natus aliquid dolore eum maxime iusto quisquam nostrum at cupiditate! 
          Accusantium, quae.
        </p>
        <div class="rating">
